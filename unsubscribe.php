        ...
        if (isset($_POST['subscribe'])) {
            ...
            if (isset($_POST['email'])) {
                ...
                if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
                    ...
                    $check_query = "SELECT * FROM visitor_det where email=?;";
                    ...
                    if ($query_no_rows == 1) {
                        ...
                        $update_data = "UPDATE visitor_det SET action='stop' WHERE email=?;";
                        $stmt = mysqli_stmt_init($mysqli);
    ...
    <form action="" method="post">
        <div class="center-div">
            <div class="in-center-div">
                <h4 class="title-data">UNSUBSCRIBE XKCD Comics</h4>
                ...
                <input type="email" id="email" name="email" placeholder="Enter your email id" class="email-input" required>
                ...
                <p style="font-size: 14px; font-weight:100;color:black;">Please click <strong> unsubscribe</strong> to add your account for mailing.</p>

                <button type="submit" class="send-btn" style="margin-top: 40px;" name="subscribe">UNSUBSCRIBE</button>
